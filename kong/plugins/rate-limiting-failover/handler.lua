...
function RateLimitingHandler:new()
  RateLimitingHandler.super.new(self, "rate-limiting-failover")
end
...
function RateLimitingHandler:access(conf)
  ...
  if usage then
    ...
    -- If limit is exceeded, modify request adding failover=true in query string, removing user from query string and
    -- adding failover=true to header
    if stop then
      -- QUERY STRING
