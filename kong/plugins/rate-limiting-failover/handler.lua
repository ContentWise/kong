...
local policies = require "kong.plugins.rate-limiting-failover.policies"
...
local RateLimitingFailoverHandler = BasePlugin:extend()

RateLimitingFailoverHandler.PRIORITY = 901
RateLimitingFailoverHandler.VERSION = "0.1.0"
...
function RateLimitingFailoverHandler:new()
...
function RateLimitingFailoverHandler:access(conf)
  ...
  if usage then
    ...
    if stop then
      ...
      querystring["failover"] = "true"
      querystring["user"] = nil
...
return RateLimitingFailoverHandler
